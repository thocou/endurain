...
class TestGetUserId:
    ...
    def test_extracts_user_id_from_context(self):
        """
        Test that get_user_id returns the integer
        client_id from the MCP access token.
        """
        ctx = MagicMock()
        ctx.request_context.access_token.client_id = "7"
    ...
    def test_extracts_large_user_id(self):
        """
    ...
    def test_raises_on_non_numeric_client_id(self):
        """
